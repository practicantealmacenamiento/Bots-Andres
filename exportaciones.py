...
EXCEL_FILE = os.path.join(FOLDER_PATH, "Backup_Exportaciones.xlsx")
...
def cerrar_excel(tiempo_espera=1):
    ...
    try:
        ...
        workbook = excel.Workbooks("Backup_Exportaciones.xlsx")
...
def ejecutar_exp(session):
    ...
    try:
        ...
        session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "Backup_Exportaciones.xlsx"
       ...
       # Cerrar la transacción en SAP enviando F3 (equivalente a sendVKey(3))
        ...
        print(f"Error al ejecutar EXP o exportar: {e}")

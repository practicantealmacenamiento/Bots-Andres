...
EXCEL_FILE = os.path.join(FOLDER_PATH, "Backup_Disnal.xlsx")
...
def cerrar_excel(tiempo_espera=1):
    ...
    try:
        ...
        workbook = excel.Workbooks("Backup_Disnal.xlsx")
...
def ejecutar_exp(session):
    ...
    try:
        ...
        # Ingresar parámetros
        session.findById("wnd[0]/usr/ctxtS1_LGNUM").text = "CED"
        ...
        session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "Backup_Disnal.xlsx"
       ...
       # Cerrar la transacción en SAP enviando F3 (equivalente a sendVKey(3))
        ...
        print(f"Error al ejecutar CED o exportar: {e}")
